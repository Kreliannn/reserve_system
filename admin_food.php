            ...
            object.forEach(function(object){
              $("#food").append(`
                <tr>
                  ...
                  <td> <form action='backend/remove_product.php' method="post">   <input type='hidden' name='food_id'   value='${object.Food_ID}'>  <input type='hidden' name='store'   value='food'><input type='submit' class='btn btn-danger' value='remove'> </form></td>
                </tr>
              `)
            })
          } else {
